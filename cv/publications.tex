...
% SUBSECTION TITLE
%-------------------------------------------------------------------------------
\entrypositionstyle{Peer reviewed}. \descriptionstyle{\textsuperscript{\textdagger} stands for equal contribution.}


\begin{etaremune}
  \renewcommand\labelenumi{\bfseries\theenumi .}
  \item \textcolor{awesome}{Rizzuto, M.}, Leroux, S. J., Schmitz, O. J., Vander Wal, E., Wiersma, Y. F., Heckford, T. R. 2023. \href{https://www.biorxiv.org/content/10.1101/2023.03.03.530982v1}{Animal-vectored nutrient flows across resource gradients influence the nature of local and meta-ecosystem functioning}. Preprint, \emph{bioRxiv}.
...
% \begin{itemize}
%   \item \textcolor{awesome}{Rizzuto, M.}, Leroux, S.J., Schmitz, O.J., Vander Wal, E., Wiersma, Y.F., Heckford, T.R. Animal-vectored nutrient flows across resource gradients influences the nature of local and meta-ecosystem functioning. In review, \emph{The American Naturalist}, manuscript id: 61395.
%   \item McLeod, A.M., Leroux, S.J., \textcolor{awesome}{Rizzuto, M.}, Leibold, M.A., Schiesari, L. Integrating ecosystem and contaminant models to study the spatial dynamics of contaminants. In review, \emph{The American Naturalist}, manuscript id: 60949.
% \end{itemize}
